    ...
    return new Sale(
      {
        ...
        unit: new Unit({
          ...
          ...(raw.unities.companies && {company: new Company({
            name: raw.unities.companies.name,
            cnpj: raw.unities.companies.cnpj,
            client_identifier: raw.unities.companies.client_identifier,
            unities: [],
            created_at: raw.unities.companies.created_at,
            updated_at: raw.unities.companies.updated_at,
            telephone: raw.unities.companies.telephone,
          }, raw.unities.companies.id)}),
        }, raw.unities.id),
        service_providers: [],
        services_sales: raw.services_sales.map(service => new ServiceSale({
          ...
          service: new Service({
            ...
            company_id: service.service.company_id || undefined,
            ...
            }, service.service.companies?.id) : undefined,
          }, service.service.id),
